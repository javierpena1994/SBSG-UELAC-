...
CURSO_MAP = {
    ...
    '8° EGB': 9, 'OCTAVO EGB': 9, '8VO EGB': 9, '8 EGB': 9, 'OCTAVO': 9, '8VO': 9, '8VO': 9,
...
# Specific slot resolution dictionary for ambiguous extractions
MANUAL_OVERRIDE_SLOTS = {
    # Brandon Pacheco (21)
    (21, 'Martes', 6): {'cursoId': 1, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Inicial 2'},
    (21, 'Martes', 9): {'cursoId': 6, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Quinto EGB'},
    (21, 'Miércoles', 3): {'cursoId': None, 'materiaId': None, 'esClase': False, 'actividad': 'Material Didáctico'},
    (21, 'Viernes', 1): {'cursoId': 4, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Tercero EGB'},
    (21, 'Viernes', 2): {'cursoId': 4, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Tercero EGB'},
    (21, 'Viernes', 3): {'cursoId': 2, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Primero EGB'},
    (21, 'Viernes', 4): {'cursoId': 1, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Inicial 2'},
    (21, 'Viernes', 6): {'cursoId': 1, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Inicial 2'},
    (21, 'Viernes', 8): {'cursoId': 3, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Segundo EGB'},
    (21, 'Viernes', 9): {'cursoId': 6, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Quinto EGB'},
    (21, 'Viernes', 10): {'cursoId': 1, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Inicial 2'},

    # Karina Vargas (27)
    (27, 'Martes', 9): {'cursoId': 9, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Octavo EGB'},
    (27, 'Miércoles', 3): {'cursoId': 10, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Noveno EGB'},
    (27, 'Jueves', 9): {'cursoId': 11, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Décimo EGB'},
    (27, 'Viernes', 2): {'cursoId': 9, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Octavo EGB'},
    (27, 'Viernes', 3): {'cursoId': 9, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Octavo EGB'},
    (27, 'Viernes', 4): {'cursoId': 10, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Noveno EGB'},
    (27, 'Viernes', 5): {'cursoId': 13, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Segundo BGU'},
    (27, 'Viernes', 8): {'cursoId': 11, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Décimo EGB'},
    (27, 'Viernes', 9): {'cursoId': 14, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Tercero BGU'},
    (27, 'Viernes', 10): {'cursoId': 12, 'materiaId': 22, 'esClase': True, 'actividad': 'Inglés Primero BGU'},

    # Jordy Vega (28)
    (28, 'Lunes', 1): {'cursoId': 10, 'materiaId': 15, 'esClase': True, 'actividad': 'Estudios Sociales Noveno EGB'},
    (28, 'Martes', 4): {'cursoId': 11, 'materiaId': 15, 'esClase': True, 'actividad': 'Estudios Sociales Décimo EGB'},
    (28, 'Jueves', 1): {'cursoId': 9, 'materiaId': 15, 'esClase': True, 'actividad': 'Estudios Sociales Octavo EGB'},
    (28, 'Jueves', 10): {'cursoId': None, 'materiaId': None, 'esClase': False, 'actividad': 'Revisión y calificación de tareas'},
    (28, 'Viernes', 4): {'cursoId': 10, 'materiaId': 15, 'esClase': True, 'actividad': 'Estudios Sociales Noveno EGB'},

    # Kerlin Chiquito (32)
    (32, 'Lunes', 1): {'cursoId': 9, 'materiaId': 25, 'esClase': True, 'actividad': 'Matemática Octavo EGB'},
    (32, 'Lunes', 10): {'cursoId': 9, 'materiaId': 6, 'esClase': True, 'actividad': 'Ciencias Naturales Octavo EGB'},
    (32, 'Martes', 10): {'cursoId': 9, 'materiaId': 6, 'esClase': True, 'actividad': 'Ciencias Naturales Octavo EGB'},
    (32, 'Jueves', 4): {'cursoId': 9, 'materiaId': 6, 'esClase': True, 'actividad': 'Ciencias Naturales Octavo EGB'},
    (32, 'Viernes', 1): {'cursoId': 9, 'materiaId': 25, 'esClase': True, 'actividad': 'Matemática Octavo EGB'},

    # Vicente Reyes (22)
    (22, 'Martes', 9): {'cursoId': None, 'materiaId': None, 'esClase': False, 'actividad': 'Revisión y calificación de tareas'},
    (22, 'Miércoles', 10): {'cursoId': None, 'materiaId': None, 'esClase': False, 'actividad': 'Elaboración de Material Didáctico'},
    (22, 'Jueves', 9): {'cursoId': None, 'materiaId': None, 'esClase': False, 'actividad': 'Elaboración de Material Didáctico'},

    # Mayra Navarro (20)
    (20, 'Martes', 9): {'cursoId': 2, 'materiaId': 11, 'esClase': True, 'actividad': 'ECA Primero EGB'}
}

def parse_teacher(pdf_path, docente_id):
    ...
    for col_idx, (dia_name, x_min, x_max) in enumerate(col_bounds):
        ...
        for r_idx, row_info in enumerate(valid_time_rows):
            ...
            override_key = (docente_id, dia_name, f_id)
            if override_key in MANUAL_OVERRIDE_SLOTS:
                ov = MANUAL_OVERRIDE_SLOTS[override_key]
                slots.append({
                    'diaSemana': dia_name,
                    'franjaHorariaId': f_id,
                    'franjaEtiqueta': row_info['etiqueta'],
                    'cursoId': ov['cursoId'],
                    'materiaId': ov['materiaId'],
                    'actividad': ov['actividad'],
                    'esClase': ov['esClase']
                })
                continue
            ...
            if is_misa:
                ...
                # Class slot!
                # If course is present, cross-reference materia from course schedule
                if curso_id is not None:
                    matched_mat = COURSE_SCHEDULE.get((curso_id, dia_name, f_id))
                    if matched_mat:
                        materia_id = matched_mat
                    elif materia_id is None:
                        materia_id = DOCENTE_DEFAULT_MATERIA.get(docente_id, 25)
                
                # If materia is present but course is missing:
                if materia_id is not None and curso_id is None:
                    if docente_id in TUTOR_COURSE_MAP:
                        curso_id = TUTOR_COURSE_MAP[docente_id]
...
# 1. Verification run
print("==================================================")
print("VERIFYING ALL TEACHER SCHEDULES (22 TEACHERS)")
print("==================================================")
all_success = True
parsed_teacher_slots = {}
...
for f in sorted(glob.glob('HORARIOS DOCENTES/*.pdf')):
    ...
    # Exclude Alexandra Acosta (1) and Anabel Falcones (31)
    if doc_id in [1, 31]:
        print(f"Skipping {base} (Docente ID {doc_id}) per user instruction (Alexandra Acosta / Anabel Falcones).")
        continue

    slots = parse_teacher(f, doc_id)
    clases = [s for s in slots if s['esClase']]
    clases_sin_materia = [s for s in clases if s['cursoId'] and not s['materiaId']]
    clases_sin_curso = [s for s in clases if s['materiaId'] and not s['cursoId'] and s['materiaId'] != 26 and s['materiaId'] != 27]
    
    if len(clases_sin_materia) > 0 or len(clases_sin_curso) > 0:
        all_success = False
        print(f"❌ ERROR in {base} (ID {doc_id}): {len(clases)} clases | {len(clases_sin_materia)} sin materia | {len(clases_sin_curso)} sin curso")
    else:
        print(f"✅ PERFECT Docente ID {doc_id:2d} ({base:30s}): {len(clases):2d} clases (100% completas), {len(slots)-len(clases):2d} libres.")
        parsed_teacher_slots[doc_id] = slots

print(f"\nAll 22 teachers verified: {all_success}")

# 2. If all verified, seed to backend DB!
if all_success:
    print("\n==================================================")
    print("SAVING VERIFIED SCHEDULES TO BACKEND VIA API")
    print("==================================================")
    for doc_id, slots in parsed_teacher_slots.items():
        ...
        try:
            with urllib.request.urlopen(req) as resp:
                ...
                print(f"✓ Saved Docente ID {doc_id:2d} successfully ({len(saved)} slots saved, HTTP {resp.status})")
